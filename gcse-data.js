// ============================================================
// GCSE SPEC DATA — RAM'S EXAM COMMAND CENTER
// All spec points sourced from official board specifications
// ============================================================
...
const GCSE_SUBJECTS = {
  ...
  furtherMaths: {
    ...
    icon: "∑",
    exams: [
      { paper: "Paper 1 (Non-Calc)", date: "2026-06-10", time: "AM" },
      { paper: "Paper 2 (Calc)",     date: "2026-06-10", time: "PM" },
    ],
    topics: [
  ...
  physics: {
    ...
    icon: "⚛",
    exams: [
      { paper: "Paper 1", date: "2026-05-15", time: "AM" },
  ...
  biology: {
    ...
    icon: "🧬",
    exams: [
      { paper: "Paper 1", date: "2026-05-13", time: "AM" },
      { paper: "Paper 2", date: "2026-06-11", time: "AM" },
    ],
    topics: [
  ...
  computerScience: {
    ...
    icon: "💻",
    exams: [
      { paper: "Paper 1 — Computer Systems",    date: "2026-05-21", time: "AM" },
      { paper: "Paper 2 — Computational Thinking", date: "2026-06-09", time: "AM" },
    ],
    topics: [
      ...
      { id: "cs7", topic: "Algorithms",         points: [
        "Computational thinking — abstraction, decomposition, pattern recognition, algorithms",
      ...
      { id: "cs8", topic: "Programming",        points: [
        ...
        "Structured Query Language — INSERT, UPDATE",
  ...
  englishLang: {
    ...
    topics: [
      ...
      { id: "el3", topic: "Language Analysis",   points: [
        "Metaphor and simile",
        "Personification",
        "Pathetic fallacy",
  ...
  englishLit: {
    ...
    icon: "📖",
    exams: [
      { paper: "Paper 1 — Shakespeare + Post-1914 Drama", date: "2026-05-14", time: "AM" },
      { paper: "Paper 2 — Poetry + 19th Century Prose",   date: "2026-06-02", time: "AM" },
    ],
    topics: [
      { id: "lit1", topic: "Romeo and Juliet (Shakespeare)", points: [
        ...
        "Theme: Youth vs age / impulsiveness",
      ...
      { id: "lit2", topic: "An Inspector Calls (Priestley)", points: [
        "Plot — Inspector Goole's arrival, each family member's connection to Eva Smith",
        ...
        "Eva Smith/Daisy Renton — symbol of the working class, never seen",
      ...
      { id: "lit3", topic: "Jekyll and Hyde (Stevenson)", points: [
        ...
        "Poole — loyalty, domestic servant, working-class witness",
        ...
        "Theme: Evolution and degeneration — Hyde as 'troglodytic'",
        "Theme: The city — London as labyrinth, fog, danger",
        "Narrative structure — multiple narrators, epistolary ending (unreliable)",
        ...
        "Context: Freud — id/ego/superego (written before Freud, but anticipates it)",
        "Context: Stevenson's own life — Edinburgh duality",
        "Context: Jack the Ripper (1888) — contemporary fears of Hyde-like figure",
      ]},
      { id: "lit4", topic: "Conflict Poetry Anthology (Edexcel)", points: [
        "Bayonet Charge — Ted Hughes: soldier's terror, instinct over ideology",
        "Remains — Simon Armitage: PTSD, guilt, haunting memory of killing",
        "Poppies — Jane Weir: maternal grief, home front, letting go",
        "War Photographer — Carol Ann Duffy: moral burden, public indifference",
        "Tissue — Imtiaz Dharker: fragility of power, paper as metaphor for life",
        "The Émigréé — Carol Rumens: exile, memory of homeland, identity",
        "Checking Out Me History — John Agard: reclaiming colonised identity",
        "Storm on the Island — Seamus Heaney: isolation, nature's power, conflict",
        "Kamikaze — Beatrice Garland: duty vs survival, shame, silence",
        "Exposure — Wilfred Owen: futility of WW1, nature as enemy, waiting",
        "London — William Blake: oppression, institutional power, poverty",
        "The Prelude (extract) — William Wordsworth: nature's sublime power",
        "My Last Duchess — Robert Browning: dramatic monologue, power, jealousy",
        "Ozymandias — Percy Bysshe Shelley: hubris, impermanence of power",
        "Comparing poems: structure and form — free verse vs sonnet vs ballad",
        "Comparing poems: voice — first person, dramatic monologue, third person",
        "Comparing poems: language — imagery, tone, register",
        "Comparing poems: key themes — conflict types (internal, war, political, natural)",
        "Unseen poem technique — annotate, identify techniques, PEE structure",
  ...
  german: {
    ...
    icon: "🇩🇪",
    exams: [
      { paper: "Listening",  date: "2026-05-22", time: "AM" },
      { paper: "Reading",    date: "2026-05-22", time: "PM" },
      { paper: "Writing",    date: "2026-06-05", time: "AM" },
      { paper: "Speaking",   date: "2026-04-27", time: "AM" },
    ],
    topics: [
      { id: "de1", topic: "Identity & Culture",  points: [
        ...
        "Food and eating — deutsche Küche",
      ]},
      ...
      { id: "de3", topic: "Current & Future Study/Employment", points: [
        "School and subjects — Schule und Fächer",
  ...
  history: {
    ...
    icon: "🏛",
    exams: [
      { paper: "Paper 1 — Medicine + WW1 Trenches", date: "2026-05-20", time: "PM" },
      { paper: "Paper 2 — Cold War + Elizabethan", date: "2026-06-03", time: "PM" },
      { paper: "Paper 3 — Nazi Germany",            date: "2026-06-12", time: "PM" },
    ],
    topics: [
...
// ── DAILY STUDY PLAN (working backwards from last exam) ───
// Last exam: History Paper 3 — 2026-06-12
// First exam: Biology Paper 1 — 2026-05-13
...
const STUDY_PHASES = [
  ...
  },
  {
    ...
    range: ["2026-05-13", "2026-06-15"],
    description: "Exams running. Light revision on upcoming subjects. No cramming the night before — sleep is revision.",
    color: "#10b981",
    dailyHours: 2,
    focus: "Targeted review of next exam only",
    subjects: [],
    atomicHabit: "Deep Work: 2×90-min sessions then full rest. No half-measures.",
  },
];
...
function getDailyRecommendation() {
  ...
  const daysUntilNext = next ? Math.ceil((new Date(next.date) - today) / 86400000) : null;

  // Build today's schedule
  const schedule = [];

  if (daysUntilNext !== null && daysUntilNext <= 3) {
    // Imminent exam — focus ONLY on that subject
    schedule.push({
      time: "Morning (90 min)",
    ...
    // Regular schedule based on day of week
    const dow = today.getDay(); // 0=Sun
    const rotation = [
      ["maths", "physics"],
      ["chemistry", "biology"],
      ["computerScience", "history"],
      ["german", "englishLang"],
      ["englishLit", "furtherMaths"],
      ["maths", "history"],
      ["physics", "chemistry"], // Sunday lighter
    ];
